...
const Step3Report = ({report}) => {
  ...
  if (finalScore >= 8) {
    performanceText = "Ready for job oppertunities."
    shortTagLine = "Excellent clarity and structurde response."
  ...
  const downloadPDF = async () => {
    ...
    doc.text("AI Interview Performace Report", pageWidth / 2, currentY, {
      align: "center"
    })
    currentY += 5
    ...
    doc.roundedRect(margin, currentY, contentWidth, 25, 4, 4)
  ...
  return (
    <div className='min-h-screen bg-linear-to-br from-gray-50 to-green-50 px-4 sm:px-6 lg:px-10 py-8'>
      <div className='mb-8 flex flex-col sm:flex-row sm:in-checked: sm:justify-between gap-4'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8'>
        <div className='space-y-6'>
          ...
          >
            <h3 className='text-gray-500 mb-4 sm:mb-6'>Overall Performance</h3>
          ...
          >
            ...
            <div className='space-y-5'>{skills.map((s,i) => (
              <div key={i}>
