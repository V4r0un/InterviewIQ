...
import confidence from '../assets/confi.png'
import crediting from '../assets/credit.png'
import evaluation from '../assets/ai-ans.png'
  ...
  return (
    <div className='min-h-screen bg-[#f3f3f3] flex flex-col'>
      ...
      <div className='flex-1 px-6 py-20'>
        <div className='max-w-6xl mx-auto'>
          <div className='flex justify-center mb-6'>
            <div className='bg-gray-100 text-gray-600 text-sm px-4 py-2 rounded-full flex items-center gap-2'>
              ...
              AI Powered Smart Intervivew Platform
            </div>
          </div>
                    ...
                    <motion.div 
                      ...
                      className='bg-white border border-gray-200 rounded-3xl p-8 shadow-sm hover:shadow-xl transition-all'>
                        <div className='flex flex-col md:flex-row items-center gap-8'>
                          <div className='w-full md:w-1/2 flex justify-center'><img src={item.image} alt={item.title} className='w-full h-auto object-contain max-h-64'/></div>
        ...
        {showAuth && <AuthModel onClose={()=>setShowAuth(true)}/>}
        <Footer />
      </div>
    )
}
